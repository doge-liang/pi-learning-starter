...
describe("pi 扩展加载器", () => {
	...
	it("jiti 发现并加载扩展：无错误；11 个 bb_* 工具、22 个命令、4 个事件、1 个条目渲染器", async () => {
		...
		assert.deepEqual(tools, ["bb_check_link", "bb_domain_set", "bb_evidence", "bb_grade", "bb_plan_propose", "bb_prequestions", "bb_proposal_review", "bb_review", "bb_sources_propose", "bb_status", "bb_test_create"]);
